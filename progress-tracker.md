...
- **Phase:** Phase 6.96 — recovery verification visibility.
...
- **Current goal:** Have the operator verify the deployed daily-run and recovery status surfaces after Clerk sign-in; recurring scheduler activation and PITR enablement remain separately gated.
