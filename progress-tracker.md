...
- **Verification:** 179 tests, typecheck, lint, production build, secret-surface audit, and diff checks pass. The normal default-disabled worker path remains unchanged; no hosted scheduler activation or database mutation occurred.
