...
- **Next smallest unit:** Deploy the API/dashboard visibility change, verify the authenticated response, then obtain explicit approval/reference for migration `0009`.
