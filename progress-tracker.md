...
- **Verification:** 174 tests, typecheck, lint, production build, secret-surface audit, and diff checks pass. No hosted query or migration was run in this phase.
- **Next smallest unit:** Run the no-write plan against Railway, then obtain explicit approval/reference before applying migration `0009`.
