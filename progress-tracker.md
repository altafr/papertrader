...
- **Phase:** Phase 6.87 — unique retry-provenance preflight.
...
- **Current goal:** Keep paper-only server readiness fail-closed; any future reconciliation retry must pass the unique approval/reference and run-ID preflight.
