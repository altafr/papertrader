...
- **Phase:** Phase 6.150 — Accelerated paper closeout rehearsal completed; recovery sign-off remains blocked by missing drill provenance.
...
- [ ] Complete post-restore recovery sign-off; current readiness is `unverified` because the recovery drill approval reference, verification timestamp, and verified flag are not persistently recorded.
