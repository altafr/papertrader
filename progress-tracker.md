...
- **Phase:** Phase 6.98 — guarded recovery readiness command.
...
- **Current goal:** Have the operator verify the deployed daily-run and recovery status surfaces after Clerk sign-in; PITR evidence must satisfy the auditable reference/timestamp contract and readiness command before verification.
