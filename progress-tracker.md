...
- **Phase:** Phase 6.92 — activation/rollback runbook hardened.
...
- **Current goal:** Have the operator verify the deployed daily-run status surface after Clerk sign-in; recurring scheduler activation remains separately gated and now has a documented rollback path.
