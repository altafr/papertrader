...
- **Verification:** 180 tests, typecheck, lint, production build, secret-surface audit, and diff checks pass. No hosted migration or database mutation occurred.
