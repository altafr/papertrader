...
- **Verification:** 176 tests, typecheck, lint, production build, secret-surface audit, and diff checks pass. No hosted command or database mutation was performed in this phase.
- **Next smallest unit:** Deploy and run the combined readiness check against Railway, then apply migration `0009` only after explicit approval/reference.
