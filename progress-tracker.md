...
- **Phase:** Phase 6.97 — auditable recovery verification contract.
...
- **Current goal:** Have the operator verify the deployed daily-run and recovery status surfaces after Clerk sign-in; PITR evidence must satisfy the auditable reference/timestamp contract before verification.
