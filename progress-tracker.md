...
- **Verification:** 185 tests, typecheck, lint, production build, secret-surface audit, and diff checks pass. No hosted migration or scheduler activation occurred.
- **Next smallest unit:** Deploy the API probe-contract change when Vercel/API deployment capacity permits, then obtain explicit approval/reference for migration `0009`.
