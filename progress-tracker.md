...
- **Phase:** Phase 6.94 — recovery runbook added.
...
- **Current goal:** Have the operator verify the deployed daily-run status surface after Clerk sign-in; recurring scheduler activation and backup execution remain separately gated.
