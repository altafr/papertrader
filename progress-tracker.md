...
- **Phase:** Phase 6.91 — daily activation rehearsal verified.
...
- **Current goal:** Have the operator verify the deployed daily-run status surface after Clerk sign-in; recurring scheduler activation remains separately gated.
