...
- **Phase:** Phase 6.95 — Railway PITR audit.
...
- **Current goal:** Have the operator verify the deployed daily-run status surface after Clerk sign-in; recurring scheduler activation and PITR enablement remain separately gated.
