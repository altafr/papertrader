...
- **Phase:** Phase 6.88 — idempotent queue reuse for guarded reconciliation.
...
- **Current goal:** Complete one demonstrable paper reconciliation from Railway through PostgreSQL to the authenticated dashboard while keeping activation gates disabled.
