...
- **Current goal:** Have the operator verify the deployed daily-run status surface after Clerk sign-in, then add the repeatable daily-run procedure while keeping activation gates disabled.
