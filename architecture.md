...
- **Stage:** Phase 6.828 account-metadata entitlement audit; continuous Paper Autopilot remains paper-only and fail-closed when broker permissions or market data are incomplete.
