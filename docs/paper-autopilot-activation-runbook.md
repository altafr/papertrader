...
- Confirm the latest reconciliation is fresh and the USD 1,000 baseline is verified.
- Confirm the fixed risk policy remains `0.25%` of equity and no more than `USD 100` planned loss per trade.
