...
describe("parsePublicHealth", () => {
  it("keeps the bounded non-sensitive heartbeat fields", () => {
    expect(parsePublicHealth({ status: "healthy", operatingMode: "paper_autopilot", release: "abc123", researchSchedule: { lastCatchupAt: "2026-08-29T19:59:00Z", lastCatchupJobId: "research-startup-1", lastCatchupStatus: "queued", lastRiskApprovedCount: 1, lastRiskCycleAt: "2026-08-29T19:58:00Z", lastRiskCycleStatus: "completed", lastRiskDecisionCount: 2, lastRunAt: "2026-08-29T19:57:00Z", status: "scheduled", nextRunAt: "2026-08-29T20:00:00Z" }, positionManagement: { readiness: "ready", unmanagedCount: 2 }, marketStream: { freshness: "fresh", freshnessMaxAgeSeconds: 1800, lastMessageAt: "2026-08-29T19:59:30Z", status: "connected" }, accountEquity: "secret" })).toEqual({ status: "healthy", operatingMode: "paper_autopilot", release: "abc123", researchSchedule: { lastCatchupAt: "2026-08-29T19:59:00.000Z", lastCatchupJobId: "research-startup-1", lastCatchupStatus: "queued", lastRiskApprovedCount: 1, lastRiskCycleAt: "2026-08-29T19:58:00.000Z", lastRiskCycleStatus: "completed", lastRiskDecisionCount: 2, lastRunAt: "2026-08-29T19:57:00.000Z", status: "scheduled", nextRunAt: "2026-08-29T20:00:00.000Z" }, positionManagement: { readiness: "ready", unmanagedCount: 2 }, marketStream: { freshness: "fresh", freshnessMaxAgeSeconds: 1800, lastMessageAt: "2026-08-29T19:59:30.000Z", status: "connected" } });
  });
